# MEATWASH — съёмочный комплект для Google Flow

Промпты на 18 клипов: 6 общих планов машины и 12 услуг. Всё снимается на ОДНОЙ машине.

> Машина серии: **Porsche 911 Turbo (930) 1975 года, тёмно-бордовый «бычья кровь», «китовый хвост», чёрные диски Fuchs, чёрные накладки бамперов, БЕЗ номерных знаков**
> Это та же машина, что сейчас стоит на сайте 3D-моделью (1975 Porsche 911 Turbo, Sketchfab, CC-BY).
...
- Не называть в промпте марку. Политика Veo ограничивает реальные бренды и логотипы, а шильдики модель всё равно коверкает. Описывать силуэт обобщённо («классическое заднемоторное купе 80-х»), а не «Porsche 930».
...
>
> В промптах машина названа прямо — «1975 Porsche 911 Turbo (930)». Так модель точнее
